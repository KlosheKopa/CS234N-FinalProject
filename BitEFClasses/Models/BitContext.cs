...
{
    public partial class BitContext : DbContext
    {
        public BitContext()
        {
        }

        public BitContext(DbContextOptions<BitContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySQL("server=127.0.0.1;uid=root;pwd=Rangerterron17;database=bits");
            }
        }
